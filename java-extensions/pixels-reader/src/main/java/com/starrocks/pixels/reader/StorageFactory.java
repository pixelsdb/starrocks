...
import io.pixelsdb.pixels.storage.localfs.LocalFSProvider;
...
public class StorageFactory
{
    ...
    private StorageFactory()
    {
        ...
        List<StorageProvider> providerList = new ArrayList<>();
        providerList.add(new LocalFSProvider());
        ...
        for (String name : schemeNames)
        {
            ...
            for (StorageProvider storageProvider : providerList)
            {
